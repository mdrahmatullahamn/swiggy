    ...
    return (
        <div id="homepage">
            <div id="leftside">
                ...
                <div id="cty">
                    <h3>Ahmedabad Bangalore Chennai Delhi Gurgaon Hyderabad Kolkata Mumbai </h3>
                </div>
                <div id="cty1">
                    <h3>Pune & more.</h3>
                </div>
            ...
            <div id="rightside">
                <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_1340/Lunch1_vlksgq" alt="jkf" />
            </div>
            <div id="part2">
